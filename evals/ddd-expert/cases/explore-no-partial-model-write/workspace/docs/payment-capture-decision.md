...
Payment is authoritative for these outcomes and publishes Payment Captured for
downstream consumers. Each consumer remains authoritative for its own reaction.
