...
Customer Support sometimes calls two display-only UI groupings a "Priority
Badge" and an "Operator Bundle". Those labels do not affect any Inventory
decision or outcome and have no business identity, lifecycle, authority, or
rule of their own.
