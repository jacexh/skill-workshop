---
name: cleanup
description: "Remove superpowers-memory fallback hooks from ~/.codex/hooks.json after native Codex hooks are enabled."
---

# Cleanup superpowers-memory fallback hooks for Codex
...
This skill removes only superpowers-memory entries from `~/.codex/hooks.json`; unrelated hooks are preserved. Re-runnable and idempotent via the plugin's installer script.
