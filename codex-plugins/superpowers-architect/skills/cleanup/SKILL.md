---
name: cleanup
description: "Remove superpowers-architect fallback hooks from ~/.codex/hooks.json after native Codex hooks are enabled."
---

# Cleanup superpowers-architect fallback hooks for Codex
...
This skill removes only superpowers-architect entries from `~/.codex/hooks.json`; unrelated hooks are preserved. Re-runnable and idempotent via the plugin's installer script.
