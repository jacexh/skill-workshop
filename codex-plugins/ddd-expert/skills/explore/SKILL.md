...
6. **Ask only evidence-bearing questions**: state the evidence, the unresolved business judgment, and a recommendation briefly; ask exactly one focused question and end the turn. Do not ask the user to select a DDD label. When all material facts are already explicit and consistent, clarification may be unnecessary.
