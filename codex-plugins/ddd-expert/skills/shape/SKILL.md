...
Define every retained Entity and Value Object in Domain language. Classify retained event semantics as local Domain Events or cross-context Integration Messages. Execution observations remain execution mechanics; record their correctness guarantees beside the Aggregate, Process Manager, or contract they protect rather than creating a Runtime Event category.
