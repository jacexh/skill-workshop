...
| Aggregate Boundary Conflict | Skipping modeling review produces broken consistency boundaries | "Which aggregate owns this invariant? If several lifecycle owners appear linked, should this be one aggregate, a Domain Event reaction, or a process/reconciler?" |
...
- Resolution: proceed / stop for user decision / return to domain-modeling
```
