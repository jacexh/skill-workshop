...
Treat the P1-P4 shell commands below as local smoke checks unless they are replaced by AST-aware Ruff/custom rules; they surface review targets, not architectural proof.
