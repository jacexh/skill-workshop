...
covers_branch: feat/codex-architect-prompt-routing@52358b0
---

# Project Knowledge Index

- [architecture.md](architecture.md) — System boundaries, components, data flows
  Key points: dual-track marketplace (Claude `plugins/` + Codex `codex-plugins/`); Codex architect now combines SessionStart, UserPromptSubmit heuristics, and an explicit standards skill; auto-release workflow is script-backed under `scripts/release/`
...
- [features.md](features.md) — Implemented features
  Key points: 3 plugins on each track; Codex architect has prompt-time standards routing plus project pattern overrides; PR-merge auto release bumps affected manifests/snippets and publishes releases

- [conventions.md](conventions.md) — Coding standards, architecture rules, workflow
  Key points: hook-runtime.js (Claude) + codex-runtime.js (Codex); content-rules.md as SSOT; `~/.codex/hooks.json` must stay strict JSON; Codex architect prompt router stays heuristic and non-blocking
