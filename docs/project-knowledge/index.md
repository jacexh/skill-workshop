...
- [architecture.md](architecture.md) — System boundaries, components, data flows
  Key points: dual-track marketplace; Codex plugins use native manifest hooks with setup fallback plus cleanup; Codex architect combines SessionStart, explicit skill routing, and standards skill without Stop interception
...
- [features.md](features.md) — Current capability map
  Key points: marketplace install paths; memory load/update/rebuild/write-lock/verify; architecture standards guidance; test design guidance; Codex native hooks, setup fallback, and fallback cleanup

- [conventions.md](conventions.md) — Coding standards, architecture rules, workflow
  Key points: hook-runtime.js (Claude) + codex-runtime.js (Codex); content-rules.md as SSOT; features.md uses grouped `####` capability entries; Codex setup installer supports install/remove modes
...
- [glossary.md](glossary.md) — Domain terminology
  Key points: includes Codex Native Hooks, Codex Setup Skill, Codex Cleanup Skill, Auto Release Pipeline, Hook Runtime, Prompt Router, KB Write Lock
