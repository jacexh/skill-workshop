...
**Positive.**
- Agents have a single page that tells them *how* to work, separate from *what* the rules are. The 12 must-not enumeration gives review-time grep targets.
