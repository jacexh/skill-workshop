...
- Artifact sources, routing, and removal of iteration closure refined by: [ADR 0009: Sparse Current DDD Artifacts and Depth-First Tactical Design](0009-sparse-current-ddd-artifacts.md)
