...
check_review_evidence_gate() {
  ...
  grep -q "Output completion gate: Required section | Present | Non-empty | If missing decision" "$review_skill" || fail "$label review output template should require completion gate columns"
