...
assert_contains "$tactical_design_adr" '`model.md` owns current Bounded Context business authority, Aggregate Capabilities, and event-triggered Commands' "Tactical Design ADR should preserve Model ownership"
