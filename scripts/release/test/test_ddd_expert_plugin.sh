...
check_review_evidence_gate() {
  ...
  grep -q "CQRS inventory: inspect write repositories and shared adapters for list/detail/history/summary/read-shaped methods" "$review_skill" || fail "$label review should require CQRS inventory rows"
