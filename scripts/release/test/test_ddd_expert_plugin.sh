...
check_review_evidence_gate() {
  ...
  grep -q "Terminal/execution fact table: Flow | Authorization fact | Execution fact | Aggregate closure fact | Owner | Recovery stance | Decision" "$review_skill" || fail "$label review output should require terminal/execution fact proof"
