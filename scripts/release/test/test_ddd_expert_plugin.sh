...
check_review_evidence_gate() {
  ...
  grep -q "Terminal/execution fact table: Row id | Flow | Execution fact | Authorization source | Amount/result scope | Idempotency/replay rule | Failure recovery | Aggregate closure condition | Decision" "$review_skill" || fail "$label review output should require terminal/execution fact proof"
