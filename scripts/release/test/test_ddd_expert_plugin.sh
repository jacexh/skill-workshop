...
assert_contains "$CLAUDE_ROOT/templates/design.md" 'semantic owner' "design template should preserve semantic ownership across runtime commitments"
assert_contains "$CLAUDE_ROOT/templates/design.md" 'execution owner' "design template should preserve execution ownership across runtime commitments"
