...
assert_contains "$claude_maintainer" 'run `node ../../scripts/validate-context-map.mjs' "artifact maintainer should invoke the bundled Context Map validator"
assert_contains "$claude_maintainer" 'aborts every apply operation with no write or semantic repair' "artifact maintainer should fail closed before invalid Context Map writes"
