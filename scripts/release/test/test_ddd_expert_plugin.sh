...
assert_contains "$CLAUDE_ROOT/skills/guard/SKILL.md" '`maintain-artifacts.mark-event-storming-implemented`' "guard should expose one narrow post-clear state transition"
...
assert_contains "$CLAUDE_ROOT/skills/guard/SKILL.md" 'DDD-significant declarations or wiring edges' "guard should use finite architecture seeds"
...
assert_contains "$ROOT/README.md" 'marks a structurally clear iteration `implemented`' "root README should expose Guard iteration closure"
