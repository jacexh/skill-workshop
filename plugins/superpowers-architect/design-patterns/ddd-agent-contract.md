...
- [ ] **CQRS port granularity**: every new interface is named for a use-case semantic capability, command/query side, and consumer-specific view. No item from §4(1) or §4(2) was introduced.
