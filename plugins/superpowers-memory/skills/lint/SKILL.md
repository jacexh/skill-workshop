...
8. For topic scope, recommend whether normal incremental ingest is enough or whether to escalate to topic-scope refresh. Use topic-scope refresh when affected routing, bidirectional module/scenario refs, owner/source anchors, or high-value object answerability remain incomplete after a narrow update.
