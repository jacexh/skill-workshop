...
- `hook-runtime.js verify` checks stale path references, shape violations, ADR integrity, readiness warnings, SSOT duplication, retrieval cost, split candidates, architecture coverage gaps including shallow service cards, missing scenario refs, legacy architecture view shards, and commit readiness.
